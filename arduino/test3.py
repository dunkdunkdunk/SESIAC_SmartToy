...
TUTORIAL_SOUND = pygame.mixer.Sound("newsound/tutorial.wav")
END_SOUND = pygame.mixer.Sound("newsound/gameover.wav")
PLAY_AGAIN_SOUND = pygame.mixer.Sound("newsound/takeball.wav")

OPENING_SOUND = pygame.mixer.Sound("newsound/openingmusic.wav")
# BEGIN_SOUND.set_volume(0.8)

# load bg
pygame.mixer.music.load("newsound/bg.wav")
